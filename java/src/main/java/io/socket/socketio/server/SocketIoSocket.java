...
public final class SocketIoSocket extends Emitter {
     ...
     */
    public void broadcast(String event, Object... args) throws IllegalArgumentException {
        broadcast( new String[] { mNamespace.getName() }, event, args);
    }
    ...
    public void broadcast(String room, String event, Object... args) throws IllegalArgumentException {
        broadcast((room != null)? new String[] { room } : new String[] { mNamespace.getName() }, event, args);
    }
